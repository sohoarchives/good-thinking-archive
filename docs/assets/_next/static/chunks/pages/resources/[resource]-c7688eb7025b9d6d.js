(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
		...
		1610: function (e, t, n) {
			...
			t.Z = function (e) {
				...
				return (0, i.jsx)(o.PB, {
					...
					noindex: c,
					openGraph: (0, r.Z)(
						{ title: d, description: n },
						h && {
							images: (h.formats ? Object.values(h.formats) : [h]).map(
								function (e) {
									return {
										url: (0, s.b)(h.url),
										width: e.width,
		...
		9392: function (e, t, n) {
			...
			var r = n(9815),
				...
				a = function (e) {
					...
					return (0, i.jsx)(o.Z, {
						variant: "h4",
						sx: [{ opacity: 0.6 }].concat((0, r.Z)(Array.isArray(n) ? n : [n])),
						children:
							((t = a),
							"LAST REVIEWED ".concat((0, s.Z)(new Date(t), "d MMMM y"))),
					});
				};
		},
		7814: function (e, t, n) {
			...
			var r = n(5893),
				...
				l = function (e) {
					...
					e: if (t.includes("vimeo")) {
						var n = t.split("/").pop();
						if (!n) break e;
						return (0, r.jsx)(i.Z, { children: s(n) });
					}
						...
						var l,
							c =
								null ===
									...
									: l[1];
						if (!c) break e;
						return (0, r.jsx)(i.Z, { children: a(c) });
					}
					return (0, r.jsxs)(o.Z, {
						children: [
							"Video url ",
			...
			var r = n(1799),
				...
				l = function (e) {
					var t,
						...
						c,
						d = e.chevronColor,
						h = (0, o.Z)(e, ["chevronColor"]);
					return (0, s.jsx)(
						a.Z,
						(0, i.Z)((0, r.Z)({}, h), {
							fill: "none",
							sx: {
								width: null !== (t = h.width) && void 0 !== t ? t : 6,
								height: null !== (n = h.height) && void 0 !== n ? n : 11,
							},
							viewBox: "0 0 "
								.concat(null !== (l = h.width) && void 0 !== l ? l : 6, " ")
								.concat(null !== (c = h.height) && void 0 !== c ? c : 11),
							children: (0, s.jsx)("path", {
								d: "M1 1L4.54986 4.99359C4.80657 5.2824 4.80657 5.7176 4.54986 6.00641L1 10",
								fill: "none",
								stroke: null !== d && void 0 !== d ? d : "#587044",
								strokeWidth: "1.8",
								strokeLinecap: "round",
							}),
						}),
			...
			var r = n(5893),
				...
				c = function (e) {
					var t = (0, a.useRouter)().asPath,
						n = "https://www.good-thinking.uk".concat(t),
						c = (0, l.useState)(!1),
						d = c[0],
						h = c[1],
						x = e.title,
						u = e.description,
						p = "".concat(x, " | Good Thinking");
					return (0, r.jsxs)(i.Z, {
						...
						children: [
							...
							(0, r.jsxs)(i.Z, {
								...
								children: [
									...
									(0, r.jsx)(s.rU, {
										href: "https://wa.me/?text=".concat(u, "\n").concat(n),
										rel: "noreferer noopener",
										target: "_blank",
				...
				m = function (e) {
					...
					return (0, r.jsxs)(r.Fragment, {
						children: [
							...
							(0, r.jsxs)(c.Z, {
								separator: (0, r.jsx)(i.Z, {
									sx: { mb: { xs: 0.2, md: 0 } },
									children: (0, r.jsx)(h.X, { chevronColor: "black" }),
								}),
						...
						children: [
							...
							(0, r.jsx)(i.Z, {
								sx: {
									...
									left: -90,
									zIndex: -1,
									display: c ? { xs: "none", md: "block" } : "none",
								},
								children: (0, r.jsx)(l(), {
									alt: "",
									layout: "fill",
							...
							(0, r.jsxs)(o.Z, {
								...
								children: [
									c ? (0, r.jsx)(i.Z, {}) : (0, r.jsx)(m, { breadcrumbs: n }),
									(0, r.jsxs)(i.Z, {
										sx: { display: { xs: c ? "flex" : "none", md: "flex" } },
										children: [
											(0, r.jsx)(s.Z, {
			...
			var r,
						...
						x = [
							{
								...
								width: "100%",
								"> :first-of-type": {
									width: { xs: "100%", md: "".concat(o, "%") },
								},
								"> :last-of-type": {
									mt: { xs: l, md: 0 },
									width: {
										xs: "100%",
										md: "calc(".concat(100 - o, "% - 80px)"),
									},
								},
							},
						].concat((0, m.Z)(Array.isArray(h) ? h : [h]));
					return r
						? (0, s.jsx)(g.Z, { sx: x, children: t })
						: (0, s.jsx)(c.Z, { sx: x, children: t });
				},
				b = n(9392),
				j = function (e) {
					var t = e.buttonColor,
						...
						children: (0, s.jsxs)(f, {
							...
							children: [
								(0, s.jsxs)(c.Z, {
									...
									children: [
										(0, s.jsx)(b.Y, { updatedAt: a, sx: { mb: 2 } }),
										(0, s.jsx)(c.Z, {
											sx: { width: "70%", margin: { xs: "0 auto", md: 0 } },
											children:
										...
										l &&
											...
											(0, s.jsx)(c.Z, {
												mt: 6,
												children: (0, s.jsx)(u.rU, {
													href: l,
													"gtm-action": "click resource",
													"gtm-location": "resource-header",
													children: (0, s.jsx)(h.Z, {
														color: t,
														tabIndex: -1,
														children: o || "Get Started",
													}),
												}),
											}),
									],
								...
								(0, s.jsx)(c.Z, {
									children: m ? (0, s.jsx)(p.n, { url: m }) : null,
								}),
							],
						}),
					});
						...
						(0, o.Z)((0, i.Z)({}, n), {
							...
							children: [
								(0, s.jsx)("img", {
									height: 17,
									width: 17,
									src: "/good-thinking-archive/assets/images/orange-dot-large.png",
									style: {
										marginRight: "20px",
										marginTop: "4px",
										width: "auto",
				...
				I = function (e) {
					...
					return (0, s.jsxs)(c.Z, {
						sx: function (e) {
							return {
								backgroundColor: e.palette.background.tile.light,
								border: "1px solid rgba(237, 229, 209, 0.7)",
								borderRadius: "30px",
								py: { xs: 4, md: 8 },
								px: { xs: 4, md: 9 },
							};
								...
								(0, s.jsx)(c.Z, {
									...
									children: (0, s.jsx)(c.Z, {
										...
										children: (0, s.jsx)(u.rU, {
											href: o,
											"gtm-action": "click resource",
											"gtm-location": "resource-body",
											children: (0, s.jsx)(h.Z, {
												color: t,
												tabIndex: -1,
												children: n || "Get Started",
											}),
										}),
									}),
								}),
				...
				T = function (e) {
					var t,
						...
						U = [
							...
							{ id: f, path: "resources/".concat(f), slug: f, title: p },
						],
						B =
							T === C.Pk.Cream ? "cream" : T === C.Pk.Peach ? "peach" : "green";
					return (0, s.jsxs)(
						l.L,
						(0, o.Z)((0, i.Z)({}, d), {
							whiteBody: !0,
							...
							children: [
								(0, s.jsx)(a.Z, {
									...
									image:
										null !==
											(t = null === h || void 0 === h ? void 0 : h.image) &&
										void 0 !== t
											? t
											: void 0,
	...
	function (e) {
		e.O(0, [231, 611, 129, 55, 774, 888, 179], function () {
			return (t = 3378), e((e.s = t));
			var t;
		});
		var t = e.O();
		_N_E = t;
